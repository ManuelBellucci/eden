...
const WhyWorkWithUs = ({ benefits }) => {
  return (
    <div className='m-14 mb-48 pt-24'>
      ...
      <p className='text-center font-normal mx-auto max-w-6xl text-primary-50 lg:text-lg mb-14'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-14'>
        ...
        <div className='flex flex-col gap-10 justify-center'>
          ...
          <p className='text-xl max-w-2xl text-primary-50'>Eden House si distingue per la sua dedizione a pochi, ma fondamentali, principi: professionalità, educazione e rispetto per il cliente. Crediamo che la base di ogni relazione di successo sia la fiducia, il rispetto reciproco, e ci impegnamo a costruire legami duraturi con ogni cliente.</p>
