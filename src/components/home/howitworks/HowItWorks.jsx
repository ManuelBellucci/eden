        ...
        <div className="m-14 pt-24">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-14">
                <div class="grid grid-rows-3">
                    <div class="flex flex-col justify-center border-l-4 p-8 hover:border-l-black transition-all ease-in hover:bg-primary-200/30 rounded-e-lg">
                        <div class="text-center">
                            <svg class="h-8 w-8 bg-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            </svg>
                        </div>
                        <h2 class="text-lg font-semibold mt-2">Facci sapere le tue esigenze</h2>
                        <p class="text-sm text-gray-500 mt-1">Contattaci per farci sapere cosa stai cercando e spiegarci le tue esigenze.</p>
                    </div>
                    <div class="flex flex-col justify-center border-l-4 p-8 hover:border-l-black transition-all ease-in hover:bg-primary-200/30 rounded-e-lg">
                        <div class="text-center">
                            <svg class="h-8 w-8  bg-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <h2 class="text-lg font-semibold mt-2">Capisci il tuo budget</h2>
                    ...
                    <div class="flex flex-col justify-center border-l-4 p-8 hover:border-l-black transition-all ease-in hover:bg-primary-200/30 rounded-e-lg">
                        ...
                        <h2 class="text-lg font-semibold mt-2">Visioniamo l'immobile</h2>
                        <p class="text-sm text-gray-500 mt-1">
                ...
                <div class="md:flex md:items-center">
                    <img src="https://images.unsplash.com/photo-1497436072909-60f360e1d4b1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2560&q=80" alt="Image" class="w-full h-full rounded-lg object-cover min-h-80" />
                </div>
            </div>
