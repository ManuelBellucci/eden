  ...
  return (
    <figure className='max-w-screen-md mx-auto text-center m-4 p-4'>
      ...
      <figcaption className='flex items-center justify-center mt-6 space-x-3 rtl:space-x-reverse'>
        <img className='w-8 lg:w-16 h-8 lg:h-16 rounded-full border-2 border-primary-500' src='https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/michael-gouch.png' alt='profile picture' loading='lazy' />
