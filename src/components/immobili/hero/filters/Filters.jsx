    ...
    return (
        <>
            ...
            <div className="flex xl:hidden justify-center mb-4">
                <button
                    className="px-4 py-2 bg-primary-500 text-white rounded-lg shadow hover:bg-primary-600"
                    onClick={toggleModal}
                >
                    Filtra Annunci
                </button>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 p-4 bg-gray-800 bg-opacity-90 z-[100] flex items-center justify-center">
                    <div className="bg-white h-full flex flex-col gap-6 relative items-center p-6 rounded-lg shadow-lg w-full max-w-lg">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-2xl">Filtri</h2>
                            <button
                                className="text-xl px-4 py-2 absolute top-5 right-5 text-white bg-primary-500 rounded-lg shadow hover:bg-primary-600"
                                onClick={toggleModal}
                            >
                                &times;
                            </button>
                        ...
                        />
                        <button
                            className="mt-4 px-4 py-2 bg-primary-500 text-white rounded-lg shadow hover:bg-primary-600"
                            onClick={toggleModal}
                        >
                            Applica filtri
                        </button>
