        ...
        <div className='flex flex-col'>
          ...
          <p className='text-xl lg:text-2xl  font-extrabold'>Disponibilità
            <small className='italic ms-2 font-semibold text-primary-700'>
              ...
              {listing.rented && (
                <div className='flex flex-col'>
                  <p className='not-italic text-xl lg:text-2xl text-black font-extrabold'>Rendita
                    <small className='italic ms-2 font-semibold text-primary-700'>
                      € {listing.annualRent ? listing.annualRent.toLocaleString() : 'N/A'},00
                    </small>
                  </p>

                  <p className='not-italic text-xl lg:text-2xl text-black font-extrabold'>Contratto
                    <small className='italic ms-2 font-semibold text-primary-700'>
                      {listing.rentContract !== null && listing.rentContract.charAt(0).toUpperCase() + listing.rentContract.slice(1)}
                    </small>
                  </p>

                  <p className='not-italic text-xl lg:text-2xl text-black font-extrabold'>Scadenza
                    <small className='italic ms-2 font-semibold text-primary-700'>
