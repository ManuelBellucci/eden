      ...
      <div className='mt-10 '>
        <div className='mb-5 pb-5 text-center h-full bg-primary-50 rounded-lg p-4 shadow-md'>
          ...
          <div className='flex flex-col'>
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Superficie
              <small className='font-sans ms-2 text-primary-800'>
                {listing.garageSqm} m²
              </small>
            </div>
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Bocca
              <small className='font-sans ms-2 text-primary-800'>
                {listing.numGarage}
              </small>
            </div>
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Altezza
              <small className='font-sans ms-2 text-primary-800'>
                {listing.numGarage}
              </small>
            </div>
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Larghezza porta
              <small className='font-sans ms-2 text-primary-800'>
                {listing.numGarage}
              </small>
            </div>
    ...
    <div className='mt-10 grid grid-cols-1 md:grid-cols-2 gap-4'>
      ...
      <div className='mb-5 pb-5 h-full bg-primary-50 rounded-lg p-4 shadow-md'>
        ...
        <div className='flex flex-col'>
          ...
          <div className='text-xl lg:text-2xl font-extrabold'>Disponibilità
            <small className='font-sans ms-2 text-primary-800'>
              ...
              {listing.rented && (
                <div className='flex flex-col'>
                  {listing.annualRent && (
                    <div className='not-italic text-xl lg:text-2xl font-extraboldtext-primary-950 '>Rendita
                      <small className='font-sans ms-2 text-primary-800'>
                  ...
                  {listing.rentContract && listing.rentedUntil && (
                    <>
                      <div className='not-italic text-xl lg:text-2xl font-extraboldtext-primary-950 '>Contratto
                        <small className='font-sans ms-2 text-primary-800'>
                          {listing.rentContract !== null && listing.rentContract.charAt(0).toUpperCase() + listing.rentContract.slice(1)}
                        </small>
                      </div>

                      <div className='not-italic text-xl lg:text-2xl font-extraboldtext-primary-950 '>Scadenza
                        <small className='font-sans ms-2 text-primary-800'>
          ...
          <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Bagni
            <small className='font-sans ms-2 text-primary-800'>
      ...
      <div className='mb-5 pb-5 h-full bg-primary-50 rounded-lg p-4 shadow-md'>
        ...
        <div className='flex flex-col'>
          {listing.closet && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Rispostiglio
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.cellar && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Cantina
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.cellar && listing.cellarSqm.length > 1 && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Metrature cantine
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.cellar && listing.cellarSqm.length === 1 && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Metratura cantina
              <small className='font-sans ms-2 text-primary-800'>
                {listing.cellarSqm}m²
              </small>
            </div>
          ...
          {listing.garage && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Garage
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.garage && listing.numGarage > 1 && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Superficie garage
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.parkingSpace && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '> o auto
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.parkingSpace && listing.numParkingSpace > 1 && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Tipologia posti auto
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.parkingSpace && listing.numParkingSpace === 1 && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Tipologia posto auto
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.privateGarden && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Giardino
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.condGarden && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Giardino condominiale
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.terrace && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Terrazzo
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.terrace && listing.numTerrace > 1 && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Superficie terrazzi
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.terrace && listing.numTerrace === 1 && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Superficie terrazzo
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.balcony && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Balcone
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.balcony && listing.numBalcony > 1 && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Superficie balconi
              <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.balcony && listing.numBalcony === 1 && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Superficie balcone
              <small className='font-sans ms-2 text-primary-800'>
      ...
      <div className='text-start h-full pb-5 mb-5 bg-primary-50 rounded-lg p-4 shadow-md'>
        ...
        <div className='flex flex-col items-start'>
          <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Prezzo
            <small className='font-sans ms-2 text-primary-800'>
              € {listing.pubPrice.toLocaleString()},00
            </small>
          </div>
          <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Prezzo al m²
            <small className='font-sans ms-2 text-primary-800'>
          ...
          {listing.monthlyCondominiumFees !== null && (
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Spese condominiali
              <small className='font-sans ms-2 text-primary-800'>
      ...
      <div>
        <div className='text-start pb-5 h-full bg-primary-50 rounded-lg p-4 shadow-md'>
          ...
          <div className='flex flex-col items-start'>
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Riscaldamento
              <small className='font-sans ms-2 text-primary-800'>
                {listing.heating !== null && listing.heating.charAt(0).toUpperCase() + listing.heating.slice(1)}, {listing.heatingType}
              </small>
            </div>

            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Classe energetica (APE)
              <small className='font-sans ms-2 text-primary-800'>
                {listing.APE ? 'Presente' + (listing.APEClass ? ` (classe ${listing.APEClass})` : '') : 'In corso'}
              </small>
            </div>
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>RTI
              <small className='font-sans ms-2 text-primary-800'>
                {listing.RTI ? 'Presente' : 'In corso'}
              </small>
            </div>
            {listing.yearOfConstruction && (
              <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Anno di costruzione
                <small className='font-sans ms-2 text-primary-800'>
                  {listing.yearOfConstruction}
                </small>
              </div>
            ...
            <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Stato interno
              <small className='font-sans ms-2 text-primary-800'>
            ...
            {listing.internalState === 'ristrutturato' && (
              <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Anno di ristrutturazione
                <small className='font-sans ms-2 text-primary-800'>
            ...
            {listing.fixtures && (
              <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Infissi
                <small className='font-sans ms-2 text-primary-800'>
                  {listing.fixtures}
                </small>
              </div>
            ...
            {listing.deliberatedCondominiumWorks && (
              <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Lavori condominiali deliberati
                <small className='font-sans ms-2 text-primary-800'>
                  {listing.deliberatedCondominiumWorks}
                </small>
              </div>
            ...
            {listing.lastCondominiumWorks && (
              <div className='text-xl lg:text-2xl font-extraboldtext-primary-950 '>Ultimi lavori condominiali
                <small className='font-sans ms-2 text-primary-800'>
                  {listing.lastCondominiumWorks}
                </small>
              </div>
