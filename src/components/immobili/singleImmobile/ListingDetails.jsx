    ...
    return (
      <div className='mt-10 '>
        <div className='mb-5 pb-5 text-center h-full bg-primary-50 rounded-lg p-4 shadow-md'>
          <h3 className='mb-4 text-2xl font-extrabold leading-nontext-primary-950 md:text-3xl lg:text-4xl uppercase'>Specifiche del garage</h3>
          <div className='flex flex-col'>
            <p className='text-xl lg:text-2xl text-primary-950 font-extrabold'>Superficie
              <small className='italic ms-2 font-semibold text-primary-500'>
                {listing.garageSqm} m²
              </small>
            </p>
