    ...
    <div className='mt-10 grid grid-cols-1 md:grid-cols-2 gap-4'>
      ...
      <div className='mb-5 pb-5 h-full bg-primary-50 rounded-lg p-4 shadow-md'>
        ...
        <div className='flex flex-col'>
          ...
          <div className='text-xl lg:text-2xl font-extrabold'>Disponibilità
            <small className='font-normal font-sans ms-2 text-primary-800'>
              ...
              {listing.rented && (
                <div className='flex flex-col'>
                  {listing.annualRent && (
                    <div className='not-italic text-xl lg:text-2xl font-extrabold text-primary-950 '>Rendita
                      <small className='font-normal font-sans ms-2 text-primary-800'>
                  ...
                  {listing.rentContract && listing.rentedUntil && (
                    <>
                      <div className='not-italic text-xl lg:text-2xl font-extrabold text-primary-950 '>Contratto
                        <small className='font-normal font-sans ms-2 text-primary-800'>
                          {listing.rentContract !== null && listing.rentContract.charAt(0).toUpperCase() + listing.rentContract.slice(1)}
                        </small>
                      </div>

                      <div className='not-italic text-xl lg:text-2xl font-extrabold text-primary-950 '>Scadenza
                        <small className='font-normal font-sans ms-2 text-primary-800'>
          ...
          <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>Bagni
            <small className='font-normal font-sans ms-2 text-primary-800'>
      ...
      <div className='mb-5 pb-5 h-full bg-primary-50 rounded-lg p-4 shadow-md'>
        ...
        <div className='flex flex-col'>
          ...
          {listing.cellar && listing.cellarSqm.length === 1 && (
            <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>Metratura cantina
              <small className='font-normal font-sans ms-2 text-primary-800'>
                {listing.cellarSqm}m²
              </small>
            </div>
          ...
          {listing.garage && (
            <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>Garage
              <small className='font-normal font-sans ms-2 text-primary-800'>
          ...
          {listing.condGarden && (
            <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>Giardino condominiale
              <small className='font-normal font-sans ms-2 text-primary-800'>
          ...
          {listing.terrace && listing.numTerrace === 1 && (
            <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>Superficie terrazzo
              <small className='font-normal font-sans ms-2 text-primary-800'>
          ...
          {listing.balcony && listing.numBalcony === 1 && (
            <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>Superficie balcone
              <small className='font-normal font-sans ms-2 text-primary-800'>
      ...
      <div className='text-start h-full pb-5 mb-5 bg-primary-50 rounded-lg p-4 shadow-md'>
        ...
        <div className='flex flex-col items-start'>
          ...
          <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>Prezzo al m²
            <small className='font-normal font-sans ms-2 text-primary-800'>
      ...
      <div>
        <div className='text-start pb-5 h-full bg-primary-50 rounded-lg p-4 shadow-md'>
          ...
          <div className='flex flex-col items-start'>
            ...
            <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>Classe energetica (APE)
              <small className='font-normal font-sans ms-2 text-primary-800'>
                {listing.APE ? 'Presente' + (listing.APEClass ? ` (classe ${listing.APEClass})` : '') : 'In corso'}
              </small>
            </div>
            <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>RTI
              <small className='font-normal font-sans ms-2 text-primary-800'>
                {listing.RTI ? 'Presente' : 'In corso'}
              </small>
            </div>
            {listing.yearOfConstruction && (
              <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>Anno di costruzione
                <small className='font-normal font-sans ms-2 text-primary-800'>
                  {listing.yearOfConstruction}
                </small>
              </div>
            ...
            <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>Stato interno
              <small className='font-normal font-sans ms-2 text-primary-800'>
            ...
            {listing.internalState === 'ristrutturato' && (
              <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>Anno di ristrutturazione
                <small className='font-normal font-sans ms-2 text-primary-800'>
            ...
            {listing.fixtures && (
              <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>Infissi
                <small className='font-normal font-sans ms-2 text-primary-800'>
                  {listing.fixtures}
                </small>
              </div>
            ...
            {listing.deliberatedCondominiumWorks && (
              <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>Lavori condominiali deliberati
                <small className='font-normal font-sans ms-2 text-primary-800'>
                  {listing.deliberatedCondominiumWorks}
                </small>
              </div>
            ...
            {listing.lastCondominiumWorks && (
              <div className='text-xl lg:text-2xl font-extrabold text-primary-950 '>Ultimi lavori condominiali
                <small className='font-normal font-sans ms-2 text-primary-800'>
                  {listing.lastCondominiumWorks}
                </small>
              </div>
