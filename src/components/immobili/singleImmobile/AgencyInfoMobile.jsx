        ...
        <form className='mt-10'>
          ...
          <div className='flex flex-col text-center mt-4 gap-2'>
            <a
              ...
              className={`flex justify-between items-center w-full px-4 py-2 text-sm font-medium text-center text-black bg-primary-300 rounded-lg hover:bg-primary-500 focus:outline-none ${isFormFilled ? '' : 'opacity-50 cursor-not-allowed'}`}
