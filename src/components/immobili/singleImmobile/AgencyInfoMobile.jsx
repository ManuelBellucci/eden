  ...
  return (
    <div className='2xl:hidden flex w-full h-full items-center justify-center col-span-2 bg-gray-100 px-4 py-6 mt-10 rounded-t-[200px]'>
      <div className='flex flex-col items-center pb-10'>
        <img loading='lazy' className='w-24 h-24 mb-3 rounded-full bg-gradient-to-t from-primary-50 to-transparent shadow-lg' src='/logo.webp' alt='logo' />
        ...
        <form className='mt-10'>
          ...
          <div className='flex flex-col text-center mt-4 gap-2'>
            <a
              ...
              className={`flex justify-between items-center w-full px-4 py-2 text-sm font-medium text-center text-primary-950 bg-primary-300 rounded-lg hover:bg-primary-500 focus:outline-none ${isFormFilled ? '' : 'opacity-50 cursor-not-allowed'}`}
            ...
            <a
              ...
              className={`flex justify-between items-center py-2 px-4 text-sm font-medium text-primary-900 focus:outline-none bg-primary-50 rounded-lg border w-full border-gray-200 hover:bg-gray-100 hover:text-primary-70 ${isFormFilled ? '' : 'opacity-50 cursor-not-allowed'}`}
              disabled={!isFormFilled}
              onClick={(e) => !isFormFilled && e.preventDefault()}
            >
