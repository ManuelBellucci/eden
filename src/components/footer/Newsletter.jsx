...
const Newsletter = () => {
  return (
    <div className='relative isolate overflow-hidden bg-primary-900 py-16 sm:py-24 lg:py-32'>
          ...
          <dl className='grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2'>
            <div className='flex flex-col items-start'>
              <div className='rounded-md bg-white/5 p-2 ring-1 ring-white/10'>
                <div className='h-6 w-6 text-white bg-primary-500' aria-hidden='true' />
              </div>
      ...
      <div className='absolute left-1/2 top-0 -z-10 -translate-x-1/2 blur-3xl xl:-top-6' aria-hidden='true'>
        <div
          className='aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-primary-200 to-primary-400 opacity-30'
          style={{
            clipPath:
