const SocialMediaIcons = () => {
    return (
        <div className="flex justify-between items-center px-14 py-6 lg:py-8">
            <span className="text-sm text-primary-300 dark:text-primary-300 sm:text-center">© 2024 <a href="https://flowbite.com/">Eden srl</a>. All Rights Reserved.
            </span>
            <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
                <a href="#" className="text-white hover:text-primary-300 hover:scale-150 transition-all ease-in">
