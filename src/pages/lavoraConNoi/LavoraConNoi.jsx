const LavoraConNoi = () => {
  return (
    <div className='flex flex-col justify-center items-center p-4 text-center text-balance'>
      ...
      <p className='font-serif text-primary-50 text-2xl'>Sei interessato a lavorare con noi? Contattaci subito!</p>
      <p className='font-serif text-primary-50 text-2xl'>Invia una mail a
